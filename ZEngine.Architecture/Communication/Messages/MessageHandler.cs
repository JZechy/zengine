...
public class MessageHandler
{
    ...
    public MessageHandler(object instance)
    {
        ...
        if (!type.IsAssignableTo(typeof(IMessageReceiver))) throw new ArgumentException("Object instance does not implement IMessageReceiver interface.");
    ...
    {
        if (!_targets.TryGetValue(target, out MethodInfo? method)) return;
